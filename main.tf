...
# The following resource block is used to create and manage GitHub Actions secrets in the repository.
...
# The following resource block is used to create and manage GitHub Actions repository permissions.

resource "github_actions_repository_permissions" "this" {
  count           = var.allowed_actions != null ? 1 : 0
  repository      = github_repository.this.name
...
# The following resource block is used to create and manage GitHub branches in the repository.
